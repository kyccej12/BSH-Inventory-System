...
<html >
  ...
  <body <?php if(isset($_GET[exception])) { ?> onLoad = "alert('<?php _returnError($_GET[exception]); ?>');" <?php } ?>>
    <div class="login">
		  <h1 style="padding-top: 10px;padding-bottom: 10px;">Black Smokehaus<br/><span style="font-size:11px">P418-A P. Burgos Street. Barangay Alang-Alang, Mandaue City</span></h1>
